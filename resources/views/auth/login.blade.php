...
/>
    ...
    <style>
        ...
        * {
        ...
        .overlay {
            background: #7d41ff;
            background: -webkit-linear-gradient(to right, #4e2bff, #417dff);
            background: linear-gradient(to right, #ae2bff, #4441ff);
...
<body>
    ...
    <h2>Welcome to Watdomnak Learning Center</h2>
